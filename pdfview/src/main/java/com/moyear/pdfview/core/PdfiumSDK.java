package com.moyear.pdfview.core;
...
import com.moyear.pdfview.bean.BookMarkNode;
import com.moyear.pdfview.bean.SearchRecord;
import com.moyear.pdfview.bean.Size;
 ...
 * @version V1.0
 * @Author : Moyear
 * @Time : 2023/6/13 10:20
 * @Description :
 */
public class PdfiumSDK {

    private static final String TAG = PdfiumSDK.class.getName();
...
//
     ...
     * Page must be opened before rendering.
     * <p>
     * For more info see {@link PdfiumSDK#renderPageBitmap(PdfDocument, Bitmap, int, long, int, int, int, int)}
     */
    public void renderPageBitmap(PdfDocument doc, Bitmap bitmap, int pageIndex, long pagePtr,
                                 int startX, int startY, int drawSizeX, int drawSizeY,
                                 boolean renderAnnot) {
