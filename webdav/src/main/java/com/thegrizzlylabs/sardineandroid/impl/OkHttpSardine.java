...
//        prop.setGetetag(objectFactory.createGetetag());
    ...
    public InputStream getWithResponse(String url, ResponseHandler responseHandler) throws IOException {
        return this.getWithResponse(url, Headers.of(Collections.emptyMap()), responseHandler);
    }

    public InputStream getWithResponse(String url, Headers headers, ResponseHandler responseHandler) throws IOException {
        Request request = new Request.Builder()
                .url(url)
                .get()
                .headers(headers)
        ...
        return new InputStreamResponseHandler().handleResponse(response);
    }

    public Response getResponseInRange(String url, Long startByte, Long endByte) throws IOException  {
        Request request = new Request.Builder()
                .url(url)
                .get()
    ...
    public Response getResponse(String url, Map<String, String> header) throws IOException  {
        Request request = new Request.Builder()
                .url(url)
                .get()
    ...
    public Long getContentLength(String url) throws IOException {
        ...
        String s = response.header("Content-Length");
    ...
    public Response getResponse(String url) throws IOException  {
        return this.getResponse(url, Collections.emptyMap());
    }
    ...
    public InputStream get(String url, Map<String, String> headers) throws IOException {
        return this.get(url, Headers.of(headers), new InputStreamResponseHandler());
    }

    public InputStream get(String url, Headers headers, InputStreamResponseHandler responseHandler) throws IOException {
        Request request = new Request.Builder()
                .url(url)
                .get()
                .headers(headers)
